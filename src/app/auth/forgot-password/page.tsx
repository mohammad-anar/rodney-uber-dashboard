    ...
    <div className="border w-full h-full min-h-[80vh] max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 p-10 bg-green-100 rounded-xl">
      <div className="w-full max-w-md px-8 flex flex-col justify-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button
            type="submit"
            className="w-full bg-primary py-6 rounded-lg text-lg font-semibold text-white  transition-colors"
          >
            Send
          </Button>
        </form>
        ...
        <div className="text-center mt-6">
          <p className="text-muted-foreground text-sm">
            ...
            <Link
              href="/auth/login"
              className="text-green-500 uppercase font-normal hover:underline"
            >
              Log in
            </Link>
          </p>
